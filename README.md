...
- `I` ou `Esc`: inventario
- `1`: usar pocao rapidamente


## Características

- A dificuldade aumenta com o passar do tempo e inimigos mais fortes aparecem com maior frequência.
- Orbes vermelhos podem ser utilizados para comprar melhorias do arco e da armadura.
- Orbes vermelhos também podem ser utilizados para comprar frascos de vida.
- Combate à distância.
- Plataforma 2D.
- Pixel Art.
...
Os assets utilizados permanecem sujeitos às suas respectivas licenças e termos de utilização, descritos na seção "Créditos".